    ...
    <section class="bg-white rounded-t-xl">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16 space-y-5">
            ...
            <div class="flex flex-col mt-5 justify-between">
                <!-- Card Event -->
                <div class="inline-flex items-center rounded-t-xl bg-green-200 px-4 py-2 lg:text-md text-sm gap-1 font-medium text-green-700 justify-between">
                ...
                <!-- Card Body -->
                <div id="open-modal" class="flex items-center justify-between rounded-b-xl bg-white p-4 border-2 border-gray-100 hover:border-green-700 cursor-pointer transition-all duration-300 ease-in-out">
