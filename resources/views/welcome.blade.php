...
<section class="">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16">
        ...
        <button type="button" class="text-gray-900 bg-white hover:bg-gray-200 cursor-pointer font-medium rounded-full text-md px-6 py-4 text-center inline-flex items-center">
            Temukan Konser
