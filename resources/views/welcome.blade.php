...
<section class="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16">
    ...
    <p class="mb-8 text-lg font-bold tracking-tight leading-none text-gray-700 md:text-3xl lg:text-2xl">
    ...
    <button class="text-white bg-gray-900 cursor-pointer font-medium rounded-full text-md px-6 py-4 inline-flex items-center">
        Temukan Konser
