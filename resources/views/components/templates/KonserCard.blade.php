...
<div class="w-full bg-white border border-gray-200 rounded-xl shadow-sm">
    ...
    <div class="p-5">
        <ul class="max-w-md list-disc list-inside font-medium {{ $konser->ketersediaan_tiket ? 'text-blue-700' : 'text-red-700' }}">
        ...
        @if ($konser->ketersediaan_tiket)
            <a href="/detail-konser/{{ $konser->id }}" 
                class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-700 hover:bg-yellow-400 rounded-lg transition">
                Lihat Konser
