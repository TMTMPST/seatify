...
<section class="bg-white rounded-t-xl">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16 space-y-5">
        <div class="flex flex-col justify-between">
            <div class="inline-flex items-center rounded-t-xl bg-red-200 px-4 py-2 text-md gap-1 font-medium text-red-600">
            ...
            <div class="flex items-center justify-between rounded-b-xl bg-white p-4 border-2 border-gray-100 hover:border-blue-800 cursor-pointer transition-all duration-300 ease-in-out">
