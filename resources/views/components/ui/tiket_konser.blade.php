<section class="bg-white rounded-t-xl">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16 space-y-5">
        <div class="flex flex-col justify-between">
            ...
            @else
                <a href="{{ route('pembayaran.detail', ['id' => $order_id]) }}" class="block w-full text-center bg-green-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-green-600 transition-all duration-300">
                    Lihat Pembayaran
                </a>
            @endif
            <!-- Card Body -->
